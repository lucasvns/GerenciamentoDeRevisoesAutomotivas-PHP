...
onManualRetry:function(){},onValidate:function(){}},messages:{typeError:"{file} extensão inválida. Extensões válidas(s): {extensions}.",sizeError:"{file} is too large, maximum file size is {sizeLimit}.",minSizeError:"{file} muito pequeno, arquivo deve ter no mínimo {minSizeLimit}.",emptyError:"{file} está vazio, por favor envie outro arquivo.",noFilesError:"Sem arquivos pro upload.",onLeave:"O upload começou, se você sair sua foto não será enviada."},retry:{enableAuto:!1,maxAutoAttempts:3,
...
if(!1===this._options.callbacks.onManualRetry(a,b))return!1;this.log("Retrying upload for '"+b+"' (id: "+a+")...");this._filesInProgress++;return!0}this.log("'"+a+"' is not a valid file ID","error");return!1},_maybeParseAndSendUploadError:function(a,b,c,d){if(!c.success)if(d&&200!==d.status&&!c.error)this._options.callbacks.onError(a,b,"XHR returned response code "+d.status);else this._options.callbacks.onError(a,b,c.error?c.error:"Upload falhou por causas desconhecidas")},_uploadFileList:function(a){var b,
...
qq.FineUploader=function(a){qq.FineUploaderBasic.apply(this,arguments);qq.extend(this._options,{element:null,listElement:null,dragAndDrop:{extraDropzones:[],hideDropzones:!0,disableDefaultDropzone:!1},text:{uploadButton:"Enviar Foto",cancelButton:"Cancel",retryButton:"Retry",failUpload:"Upload falhou",dragZone:"Coloque arquivos aqui para o Upload",formatProgress:"{percent}% of {total_size}",waitingForResponse:"Processando..."},template:'<div class="qq-uploader">'+(!this._options.dragAndDrop||!this._options.dragAndDrop.disableDefaultDropzone?
'<div class="qq-upload-drop-area"><span>{dragZoneText}</span></div>':"")+(!this._options.button?'<div class="qq-upload-button btn btn-success"><div>{uploadButtonText}</div></div>':"")+(!this._options.listElement?'<ul class="qq-upload-list"></ul>':"")+"</div>",fileTemplate:'<li><div class="qq-progress-bar"></div><span class="qq-upload-spinner"></span><span class="qq-upload-finished"></span><span class="qq-upload-file"></span><span class="qq-upload-size"></span><a class="qq-upload-cancel" href="#">{cancelButtonText}</a><a class="qq-upload-retry" href="#">{retryButtonText}</a><span class="qq-upload-status-text">{statusText}</span></li>',
